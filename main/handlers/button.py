...
def handle_button(update: Update, context: CallbackContext) -> None:
    ...
    if query.data == 'addbirthday':
        ...
        query.message.reply_text("🔄 Если вам что-то не понравилось в сгенерированном поздравлении, не стесняйтесь просить об изменениях. 😊 Вы также можете добавить дополнительные детали или пожелания!",

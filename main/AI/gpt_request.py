...
def get_category_context(category):
    contexts = {
        "Друзья": "Напиши неформальное поздравление для друга. Включи личные истории или упомяни общие воспоминания, если они известны.",
        "Работа": "Напиши формальное поздравление для коллеги по работе. Используй уважительное обращение на ВЫ или на ТЫ в зависимости от формата имени. Упомяни достижения в работе и профессиональные успехи.",
        "Учёба": "Напиши неформальное поздравление для знакомого по учёбе. Упомяни общие учебные моменты и пожелай успехов в обучении и будущей карьере.",
        "Родственники": "Напиши поздравление для родственника с акцентом на традиционные пожелания, такие как счастье, здоровье и семейное благополучие. Упомяни возрастные особенности и семейные связи.",
        "Преподаватели": "Напиши формальное поздравление для преподавателя. Используй уважительное обращение и подчеркни важность его/её вклада в образование и обучение.",
        "Хобби": "Напиши поздравление с акцентом на хобби именинника. Упомяни его/её увлечения и пожелай успехов и удовольствия в любимом деле.",
        "Знакомые": "Напиши нейтральное поздравление для знакомого. Пожелай всего самого лучшего без акцента на конкретные детали."
    }
    return contexts.get(category, "Напиши универсальное поздравление.")
    ...
    messages = [
        {
            ...
            "text": ("Ты ассистент, специализирующийся на создании уникальных поздравлений с днем рождения. "
                     ...
                     "5. По умолчанию, поздравление должно быть неформальным, если указано имя или имя и фамилия.\n"
                     ...
                     "10. Если есть сообщение '#SYS-Предыдущее сообщение:', игнорировать категорию и изменять предыдущее сообщение."
                     )
        }
    ]
